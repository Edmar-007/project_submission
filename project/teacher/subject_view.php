      ...
      <div class="review-card-grid">
        <?php foreach ($submissions as $submission): ?>
          <article class="card review-queue-card">
            <div class="split-header"><div><h3 class="section-title"><?= h($submission['full_name']) ?></h3><div class="muted small"><?= h($submission['activity_title']) ?> · <?= h($submission['section_name']) ?></div></div><?= status_badge($submission['status']) ?></div>

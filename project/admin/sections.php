...
<div class="modal-backdrop" data-modal="section-edit-<?= (int) $row['id'] ?>" aria-hidden="true">
  <div class="modal-card" role="dialog" aria-modal="true">
    ...
    <form method="post" class="form-modal-grid">
      ...
      <div class="full d-flex justify-content-end gap-2"><button class="btn btn-outline" type="button" data-close-modal>close</button><button class="btn" type="submit">save</button></div>
    </form>
  </div>
</div>
<?php endforeach; ?>
...
<div class="modal-backdrop" data-modal="admin-add-section" aria-hidden="true">
  <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="admin-add-section-title">
    ...
    <div class="modal-body">
      <form id="admin-add-section-form" method="post" class="form-grid">
        <input type="hidden" name="_csrf" value="<?= h(csrf_token()) ?>">
    ...
    <div class="modal-footer">
      <button class="btn" type="submit" form="admin-add-section-form">Create section</button>

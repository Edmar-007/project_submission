  ...
  <div class="student-page-card">
    ...
    <div class="student-notification-list">
      <?php foreach ($rows as $row): ?>
        <article id="notification-<?= (int) $row['id'] ?>"
                 class="student-notification-card <?= (int) $row['is_read'] === 0 ? 'is-unread' : '' ?>"
            ...
            <div class="student-notification-actions">
              ...
              <?php if ((int) $row['is_read'] === 0): ?>
                <form method="post">
                  ...
                  <button class="btn btn-ghost btn-sm" type="submit" title="Mark as read">Mark as read</button>
                </form>
              <?php endif; ?>
            </div>
          </div>

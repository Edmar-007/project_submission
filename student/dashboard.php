<?php
if (defined('FILE_STUDENT_DASHBOARD_PHP_LOADED')) { return; }
define('FILE_STUDENT_DASHBOARD_PHP_LOADED', true);
          ...
          <?php foreach ($subjects as $subject): ?>
            ...
            <div class="list-item">
              <div>
                ...
                <div class="muted small"><?= h($subject['subject_code']) ?> · <?= h($subject['teacher_name']) ?></div><div class="muted small"><?= h(($subject['deadline_window']['label'] ?? 'No active deadlines')) ?></div>
              </div>
              <?php if ($team): ?>

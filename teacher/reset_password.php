<?php
if (defined('FILE_TEACHER_RESET_PASSWORD_PHP_LOADED')) { return; }
define('FILE_TEACHER_RESET_PASSWORD_PHP_LOADED', true);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($password) < 8 || $password !== $confirm) {
        ...
        redirect_to('teacher/reset_password.php?token=' . urlencode($token));
    }

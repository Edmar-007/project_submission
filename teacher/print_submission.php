...
<div class="grid cols-2" style="margin-top:18px;">
  ...
  <div class="card"><h3 class="section-title">Feedback</h3><p><?= nl2br(h($submission['teacher_feedback'] ?: 'No feedback yet.')) ?></p><?php if (has_demo_access($submission)): ?><div class="callout" style="margin-top:16px;"><strong>Demo access</strong><div class="muted small">Username: <?= h($submission['admin_username'] ?: '—') ?></div><div class="muted small">Password: <?= h($submission['admin_password'] ?: '—') ?></div></div><?php endif; ?></div>
</div>
